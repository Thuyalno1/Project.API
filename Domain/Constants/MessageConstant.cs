namespace Domain.Constants
{
	public static class MessageConstant
	{
		...
		public static class NhanVienMessage
		{
			public const string MISSING_PARAM_TEN = "Common_701"; // thieu tham so ten
		}
    
		public static class PhongBanMessage
		{
			public const string MISSING_PARAM_PB = "Common801";// pb k ton tai 
		}
